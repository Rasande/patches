...
if ( ! class_exists( 'Rasande_WP_Navwalker' ) ) {
    class Rasande_WP_Navwalker extends Walker_Nav_Menu {
        public function start_lvl(&$output, $depth = 0, $args = array()) {
            ...
            $output .= "\n$indent<button class=\"dropdown-menu__btn \" type=\"button\"><i class=\"dropdown-icon\"></i></button>\n";
        ...
        public function start_el( &$output, $item, $depth = 0, $args = array(), $current_object_id = 0 ) {
            ...
            $item_classes = array(
                ...
                'depth_class'               => $depth >=1 ? $item_class = 'nav__item--dropdown' . " " . 'menu-item-' . $item->ID : '',
                'parent_class'              => $args->has_children ? $parent_class = 'has-dropdown' : '',
